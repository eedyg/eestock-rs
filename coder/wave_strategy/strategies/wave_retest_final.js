// =============================================================================
// 交付策略（ensemble 成员）主涨段捕获·中枢突破 —— 冻结配置为默认（entry_mode=1：
// 训练窗对照显示回踩确认在本宇宙 ETF 上增量为负，见实验日志 H5）。
// 原实验头部：wave_retest —— 组合⑤ 缠论三买 / Wyckoff LPS：中枢突破 + 回踩不破确认
...
const PARAMS_SCHEMA = [
  ...
  { key: "entry_mode", type: "int", default: 1, min: 0, max: 1, description: "0=回踩确认 1=突破即入" }
];
