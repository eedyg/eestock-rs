// =============================================================================
// 实验插件 wave_donchian —— 组合① Donchian 突破 × 量能 × Regime（趋势/ADX）
...
const PARAMS_SCHEMA = [
  ...
  { key: "exit_n", type: "int", default: 10, min: 3, max: 60, description: "离场窗口（Donchian 低点）" },
  ...
  { key: "use_vol", type: "int", default: 1, min: 0, max: 1, description: "量能过滤开关" },
  { key: "use_regime", type: "int", default: 1, min: 0, max: 1, description: "Regime 过滤开关" },
  { key: "use_adx", type: "int", default: 1, min: 0, max: 1, description: "ADX 过滤开关" },
