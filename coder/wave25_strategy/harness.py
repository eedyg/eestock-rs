#!/usr/bin/env python3
"""任务136 主涨段行业定义正面检验（结构前提H-A / 完整TSMOM H-B / 尺度混合H-C）实验 harness。
沿用任务134 口径（仅经平台 REST，不改系统源码；同宇宙8 ETF、同5年窗、同费率、同时间切分）。
所有提交/结果落 coder/wave25_strategy/runs/（run id 钉住复现）。"""
