...
RUN for c in alert app application backtest collector diagnose domain mcp providers storage tushare web; do mkdir -p "crates/$c/src"; : > "crates/$c/src/lib.rs"; done
RUN cargo fetch
COPY crates ./crates
